...
// I assigned month-to-season mapping based on what normally happens in southern hemisphere
...
// this is a "helper" function which sets the stitch style based on the season
