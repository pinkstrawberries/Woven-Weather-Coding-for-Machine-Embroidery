...
void setup() {
  ...
  String outputFilePath = sketchPath("September_and_October.vp3");
  String pesOutputFilePath = sketchPath("September_and_October.pes");
  ...
  // Draw the hexagons for September and October with temperatures from JSON data
  drawMonthlyHexagons("2023-09", 250, 250); // September (Top Left)
  drawMonthlyHexagons("2023-10", 700, 250); // October (Top Right)
