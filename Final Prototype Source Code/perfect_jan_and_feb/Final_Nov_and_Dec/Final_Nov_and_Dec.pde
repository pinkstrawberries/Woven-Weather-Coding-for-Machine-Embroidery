...
void setup() {
  ...
  String outputFilePath = sketchPath("November_and_December.vp3");
  String pesOutputFilePath = sketchPath("November_and_December.pes");
  ...
  // Draw the hexagons for November and December with temperatures from JSON data
  drawMonthlyHexagons("2023-11", 250, 250); // November (Top Left)
  drawMonthlyHexagons("2023-12", 700, 250); // December (Top Right)
