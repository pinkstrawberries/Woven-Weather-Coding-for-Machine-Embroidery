...
void setup() {
  ...
  String outputFilePath = sketchPath("July_and_August.vp3");
  String pesOutputFilePath = sketchPath("July_and_August.pes");
  ...
  // Draw the hexagons for July and August with temperatures from JSON data
  drawMonthlyHexagons("2023-07", 250, 250); // July (Top Left)
  drawMonthlyHexagons("2023-08", 700, 250); // August (Top Right)
