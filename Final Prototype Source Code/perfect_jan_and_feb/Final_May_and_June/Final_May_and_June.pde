...
void setup() {
  ...
  String outputFilePath = sketchPath("May_and_June.vp3");
  String pesOutputFilePath = sketchPath("May_and_June.pes");
  ...
  // Draw the hexagons for May and June with temperatures from JSON data
