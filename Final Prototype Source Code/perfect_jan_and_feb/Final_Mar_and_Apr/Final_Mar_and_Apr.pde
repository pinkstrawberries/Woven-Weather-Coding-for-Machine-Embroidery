...
void setup() {
  ...
  String outputFilePath = sketchPath("Mar_and_Apr.vp3");
  String pesOutputFilePath = sketchPath("Mar_and_Apr.pes");
  ...
  // Draw the hexagons for March and April with temperatures from JSON data
  drawMonthlyHexagons("2023-03", 250, 250); // March (Top Left)
  drawMonthlyHexagons("2023-04", 700, 250); // April (Top Right)
